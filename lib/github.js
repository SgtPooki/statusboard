...
module.exports.getReadme =
  async function getReadme (graphQL, owner, repo) {
    try {
      const resp = await graphQL({
        query: ` query($org: String!, $repo: String!, $path: String!, $pathLower: String!, $pathUpper: String!) {
          repository(name: $repo, owner: $org) {
            ...
            altLower: object(expression: $pathLower) {
              ... on Blob {
                text
              }
            }
            altUpper: object(expression: $pathUpper) {
              ... on Blob {
                text
              }
            }
        ...
        repo: repo,
        path: `main:README.md`,
        pathLower: `main:readme.md`,
        pathUpper: `main:Readme.md`
      })
      let readmeText
